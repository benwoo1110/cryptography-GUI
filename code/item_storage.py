...
frame: {}
hover_action: {}
runclass:{}, runclass_parameter:{}'''.format(self.name, self.type, self.meta, list(self.images.keys()), self.frame, self.hover_action, self.runclass, self.runclass_parameter)
